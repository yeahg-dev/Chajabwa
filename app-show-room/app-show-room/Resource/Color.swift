...
enum Color {
    ...
    static let lightSkyBlue = UIColor(named: "lightSkyBlue")!
    static let grayLavender = UIColor(named: "grayLavender")!
    static let mauveLavender = UIColor(named: "mauveLavender")!
    ...
    static let tintedLilac = UIColor(named: "tintedLilac")!
